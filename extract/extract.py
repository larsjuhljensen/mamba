...
class Extract(reflect.tagging.TaggingRequest):
	...
	def tagging(self):
		...
		document = tagger.create_html(document=document, document_id=self.document_id, matches=matches, basename='extract', add_events=False, extra_classes=True, force_important=False, html_footer="")
